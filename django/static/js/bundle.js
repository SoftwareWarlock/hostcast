...
var PodcastList = React.createClass({
    ...
    render: function () {
        var podcasts = this.state.podcasts.map(function (podcast) {
            return React.createElement(Podcast, { podcast: podcast, key: podcast.id });
        });
...
ReactDOM.render(React.createElement(PodcastList, { url: '/api/podcasts/' }), document.getElementById('content'));

},{"./PodcastsService":160,"react":159,"react-dom":30}]},{},[161]);
